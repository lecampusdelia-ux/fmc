...
export const Menu = () => {
  ...
  const deleteSelectedItems = useCallback(
    async (itemsToDeleteIds: string[]) => {
      ...
      if (errors.length === 0) {
        toast.success(`${deletedCount} discussion${deletedCount === 1 ? '' : 's'} supprimée${deletedCount === 1 ? '' : 's'} avec succès`);
      } else {
        toast.warning(`Suppression de ${deletedCount} sur ${itemsToDeleteIds.length} discussions. ${errors.length} ont échoué.`, {
          autoClose: 5000,
        });
      }
  ...
  const handleBulkDeleteClick = useCallback(() => {
    if (selectedItems.length === 0) {
      toast.info('Sélectionnez au moins une discussion à supprimer');
      return;
    }
    ...
    if (selectedChats.length === 0) {
      toast.error('Impossible de trouver les discussions sélectionnées');
      return;
    }
    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-white dark:bg-gray-950 border-r border-fmc-elements-borderColor',
          'shadow-sm text-sm',
      ...
      >
        <div className="h-12 flex items-center justify-between px-4 border-b border-gray-100 dark:border-gray-800/50 bg-gray-50/50 dark:bg-gray-900/50 rounded-tr-2xl">
          ...
          <div className="flex items-center gap-3">
            <HelpButton onClick={() => window.open('https://stackblitz-labs.github.io/fmc/', '_blank')} />
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          ...
          <div className="flex items-center justify-between text-sm px-4 py-2">
            <div className="font-medium text-gray-600 dark:text-gray-400">Vos discussions</div>
            {selectionMode && (
                ...
                {dialogContent?.type === 'delete' && (
                  <>
                    <div className="p-6 bg-white dark:bg-gray-950">
                      <DialogTitle className="text-gray-900 dark:text-white">Supprimer la discussion ?</DialogTitle>
                    ...
                    <div className="p-6 bg-white dark:bg-gray-950">
                      ...
                      <DialogDescription className="mt-2 text-gray-600 dark:text-gray-400">
                        <p>
                          ...
                          {dialogContent.items.length === 1 ? 'discussion' : 'discussions'}:
                        </p>
