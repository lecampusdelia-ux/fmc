...
const NotificationsTab = () => {
  ...
  const handleClearNotifications = () => {
    ...
    logStore.logInfo('Notifications effacées', {
      type: 'notification_clear',
      message: `${count} notifications effacées`,
      clearedCount: count,
  ...
  const handleUpdateAction = (updateUrl: string) => {
    logStore.logInfo('Lien de mise à jour cliqué', {
      type: 'update_click',
  ...
  const handleFilterChange = (newFilter: FilterType) => {
    logStore.logInfo('Filtre de notification modifié', {
      type: 'filter_change',
      message: `Filtre modifié en ${newFilter}`,
      ...
      return (
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-1 text-xs text-gray-500 dark:text-gray-500">
            ...
            <p>Dernière version : {details.latestVersion}</p>
        ...
        {filteredLogs.length === 0 ? (
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              <h3 className="text-sm font-medium text-gray-900 dark:text-white">Pas de notifications</h3>
