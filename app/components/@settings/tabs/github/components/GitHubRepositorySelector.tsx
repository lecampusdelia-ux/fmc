  ...
  if (!isConnected || !connection) {
    return (
      <div className="text-center p-8">
        <p className="text-fmc-elements-textSecondary mb-4">Please connect to GitHub first to browse repositories</p>
  ...
  if (isStatsLoading && !stats) {
    return (
      <div className="flex flex-col items-center justify-center p-8 space-y-4">
        ...
        <p className="text-sm text-fmc-elements-textSecondary">Loading repositories...</p>
      </div>
    );
  }
  ...
  if (!repositories.length) {
    return (
      <div className="text-center p-8">
        ...
        <p className="text-fmc-elements-textSecondary mb-4">No repositories found</p>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-fmc-elements-textPrimary">Select Repository to Clone</h3>
      ...
      {currentRepositories.length > 0 ? (
        ...
        <div className="text-center py-8">
          <p className="text-fmc-elements-textSecondary">No repositories found matching your search criteria.</p>
        </div>
      )}
