...
export function DataVisualization({ chats }: DataVisualizationProps) {
  ...
  const chartColors = {
    ...
    text: getThemeColor('--fmc-elements-textPrimary'),
    textSecondary: getThemeColor('--fmc-elements-textSecondary'),
    background: getThemeColor('--fmc-elements-bg-depth-1'),
    accent: getThemeColor('--fmc-elements-button-primary-text'),
    border: getThemeColor('--fmc-elements-borderColor'),
  };

  const getChartColors = (index: number) => {
    // Define color palettes based on FMC design tokens
    const baseColors = [
      // Indigo
      {
        base: getThemeColor('--fmc-elements-button-primary-text'),
      },
      ...
      // Green
      {
        base: getThemeColor('--fmc-elements-icon-success'),
      },
  ...
  if (chats.length === 0) {
    return (
      <div className="text-center py-8">
        <div className="i-ph-chart-line-duotone w-12 h-12 mx-auto mb-4 text-fmc-elements-textTertiary opacity-80" />
        <h3 className="text-lg font-medium text-fmc-elements-textPrimary mb-2">Aucune donnée disponible</h3>
        <p className="text-fmc-elements-textSecondary">
          Commencez à créer des discussions pour voir vos statistiques d'utilisation et la visualisation des données.
        </p>
      </div>
    );
  }
  ...
  const cardClasses = classNames(
    ...
    'bg-fmc-elements-bg-depth-1',
    'border border-fmc-elements-borderColor',
  );

  const statClasses = classNames('text-3xl font-bold text-fmc-elements-textPrimary', 'flex items-center gap-3');

  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-fmc-elements-textPrimary mb-4">Total des discussions</h3>
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-fmc-elements-textPrimary mb-4">Total des messages</h3>
          <div className={statClasses}>
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-fmc-elements-textPrimary mb-4">Moy. Messages/Chat</h3>
          <div className={statClasses}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-fmc-elements-textPrimary mb-6">Historique des discussions</h3>
          <div className="h-64">
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-fmc-elements-textPrimary mb-6">Distribution des messages</h3>
          <div className="h-64">
      ...
      {apiKeyUsage.length > 0 && (
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-fmc-elements-textPrimary mb-6">Utilisation de l'API par fournisseur</h3>
          <div className="h-64">
