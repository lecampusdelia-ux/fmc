  ...
  return (
    <motion.button
      ...
      className={classNames(
        'text-fmc-elements-textTertiary hover:text-fmc-elements-textSecondary dark:text-fmc-elements-textTertiary-dark dark:hover:text-fmc-elements-textSecondary-dark',
        'rounded-lg hover:bg-fmc-elements-background-depth-2 dark:hover:bg-fmc-elements-background-depth-3',
