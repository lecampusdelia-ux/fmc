        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-fmc-elements-background-depth-2 dark:bg-fmc-elements-background-depth-3 text-fmc-elements-textPrimary dark:text-fmc-elements-textPrimary-dark hover:bg-fmc-elements-background-depth-3 dark:hover:bg-fmc-elements-background-depth-4 border border-fmc-elements-borderColor dark:border-fmc-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
