  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-fmc-elements-borderColor bg-fmc-elements-background-depth-1 text-fmc-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-fmc-elements-textSecondary', className)} {...props} />;
  },
);
