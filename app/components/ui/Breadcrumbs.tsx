      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-fmc-elements-textPrimary dark:text-fmc-elements-textPrimary-dark'
              : 'text-fmc-elements-textSecondary dark:text-fmc-elements-textSecondary-dark hover:text-fmc-elements-textPrimary dark:hover:text-fmc-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-fmc-elements-textTertiary dark:text-fmc-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
