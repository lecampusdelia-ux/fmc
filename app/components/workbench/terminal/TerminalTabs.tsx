  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-fmc-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-fmc-elements-background-depth-2 border-y border-fmc-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-fmc-elements-terminals-buttonBackground text-fmc-elements-textSecondary hover:text-fmc-elements-textPrimary':
                            isActive,
                          'bg-fmc-elements-background-depth-2 text-fmc-elements-textSecondary hover:bg-fmc-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-fmc-elements-terminals-buttonBackground text-fmc-elements-textPrimary': isActive,
                            'bg-fmc-elements-background-depth-2 text-fmc-elements-textSecondary hover:bg-fmc-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-fmc-elements-textTertiary hover:text-fmc-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              title="Réinitialiser le Terminal"
              size="md"
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachFmcTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting fmc terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachFmcTerminal(terminal)}
