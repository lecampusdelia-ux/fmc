...
export const DeployButton = ({
  ...
  return (
    <>
      <div className="flex border border-fmc-elements-borderColor rounded-md overflow-hidden text-sm">
        <DropdownMenu.Root>
          ...
          >
            {isDeploying ? `Déploiement vers ${deployingTo}...` : 'Déployer'}
          ...
          >
            ...
            >
              ...
              <span className="mx-auto">
                {!netlifyConn.user ? 'Aucun compte Netlify connecté' : 'Déployer sur Netlify'}
              </span>
            ...
            >
              <img
                ...
                alt="github"
              />
              <span className="mx-auto">Déployer sur GitHub</span>
            </DropdownMenu.Item>
            ...
            >
              <img
                ...
                alt="gitlab"
              />
              <span className="mx-auto">{!gitlabIsConnected ? 'Aucun compte GitLab connecté' : 'Déployer sur GitLab'}</span>
            </DropdownMenu.Item>

            <DropdownMenu.Item
              disabled
              className="flex items-center w-full rounded-md px-4 py-2 text-sm text-fmc-elements-textTertiary gap-2 opacity-60 cursor-not-allowed"
            >
              <img
                className="w-5 h-5"
                height="24"
                ...
                alt="cloudflare"
              />
              <span className="mx-auto">Déployer sur Cloudflare (Prochainement)</span>
            </DropdownMenu.Item>
          </DropdownMenu.Content>
        </DropdownMenu.Root>
      </div>
