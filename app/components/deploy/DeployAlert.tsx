          ...
          >
            <div
              className={classNames(
                'text-xl',
                type === 'success'
                  ? 'i-ph:check-circle-duotone text-fmc-elements-icon-success'
                  : type === 'error'
                    ? 'i-ph:warning-duotone text-fmc-elements-button-danger-text'
                    : 'i-ph:info-duotone text-fmc-elements-loader-progress',
              )}
            ></div>
          </motion.div>
          {/* Content */}
                ...
                <div className="mt-4 mb-2">
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <div className="flex items-center">
                      <div
                        className={classNames(
                          ...
                          buildStatus === 'running'
                            ? 'bg-fmc-elements-loader-progress'
                            : buildStatus === 'complete'
                              ? 'bg-fmc-elements-icon-success'
                              : buildStatus === 'failed'
                                ? 'bg-fmc-elements-button-danger-background'
                    ...
                    <div
                      className={classNames(
                        'h-0.5 w-8',
                        buildStatus === 'complete' ? 'bg-fmc-elements-icon-success' : 'bg-fmc-elements-textTertiary',
                      )}
                    ></div>
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="ml-2">Déploiement</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              {url && type === 'success' && (
                <div className="mt-2">
                  <a
                    ...
                    className="text-fmc-elements-item-contentAccent hover:underline flex items-center"
                  >
                    <span className="mr-1">Voir le site déployé</span>
            ...
            >
              <div className={classNames('flex gap-2')}>
                {type === 'error' && (
                  <button
                    onClick={() =>
                      postMessage(`*Corrige cette erreur de déploiement*\n\`\`\`\n${content || description}\n\`\`\`\n`)
                    }
                    className={classNames(
