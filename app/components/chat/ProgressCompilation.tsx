      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-fmc-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-fmc-elements-item-backgroundAccent hover:bg-fmc-elements-artifacts-backgroundHover"
