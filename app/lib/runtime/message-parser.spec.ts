...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out fmc artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <boltArtifacs></fmcArtifact>', 'Foo bar <boltArtifacs></fmcArtifact>'],
      ['Before <oltArtfiact>foo</fmcArtifact> After', 'Before <oltArtfiact>foo</fmcArtifact> After'],
      ['Before <fmcArtifactt>foo</fmcArtifact> After', 'Before <fmcArtifactt>foo</fmcArtifact> After'],
    ])('should correctly parse chunks and strip out fmc artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <fmcArtifact title="Some title" id="artifact_1">foo bar</fmcArtifact> Some more text',
        {
      ...
      [
        [
          ...
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</fmcArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</fmcArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <fmcArtifact title="Some title" id="artifact_1">foo</fmcArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <fmcArtifact title="Some title" id="artifact_1"><fmcAction type="shell">npm install</fmcAction></fmcArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <fmcArtifact title="Some title" id="artifact_1"><fmcAction type="shell">npm install</fmcAction><fmcAction type="file" filePath="index.js">some content</fmcAction></fmcArtifact> After',
        {
          output: 'Before  After',
