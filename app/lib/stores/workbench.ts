...
export class WorkbenchStore {
  ...
  get fmcTerminal() {
    return this.#terminalStore.fmcTerminal;
  }
  get alert() {
  ...
  attachFmcTerminal(terminal: ITerminal) {
    return this.#terminalStore.attachFmcTerminal(terminal);
  }
